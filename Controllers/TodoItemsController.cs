...
namespace TodoApi.Controllers
{
    public class TodoItemsController : ApiController
    {
        ...
        // GET: api/TodoItems/todo
        public IQueryable<TodoItem> GetTodoItems(string filterName)
        {
            if (string.IsNullOrEmpty(filterName))
                return db.TodoItems.Include(item => item.Category);
            else
                return db.TodoItems.Include(item => item.Category).Where(item => item.Name.Contains(filterName));
        }
